...
ggsave("Output/Models/HR_PTB_COX_panel_IDW.png",
  #plot     = last_plot(),
  res      = 300,
  width    = 25,
  height   = 17,
...
ggsave("Output/Models/HR_PTB_COX_panel_OV_IDW.png",
  plot     = g1,
  res      = 300,
  width    = 25,
  height   = 10,
...
ggsave("Output/Models/HR_PTB_COX_panel_HE_IDW.png",
  plot     = g2,
  res      = 300,
  width    = 25,
  height   = 10,
...
for (dv in dep_vars) {
  ...
  outfile <- sprintf("Output/Models/HR_%s_COX_panel_IDW.png", dv)
  ggsave(outfile,
         plot = panel,
