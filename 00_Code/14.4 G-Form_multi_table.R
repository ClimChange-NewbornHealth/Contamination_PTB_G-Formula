# 14.4 G-Formula multicontaminante — tabla resumen de efectos poblacionales ----
#
# Uso (desde la raíz del proyecto):
#   Rscript "00_Code/14.4 G-Form_multi_table.R"
#
# Entrada:
#   02_Output/G-Form-Multi/Summary_results/{pm25,no2,o3}_pct20_point_estimates.xlsx
#   02_Output/G-Form-Multi/Bootstrap/{stub}/population_boot.csv  (IC de PAF si existe)
# Salida:
#   02_Output/G-Form-Multi/Summary_results/Table_population_effects_summary.xlsx
#
