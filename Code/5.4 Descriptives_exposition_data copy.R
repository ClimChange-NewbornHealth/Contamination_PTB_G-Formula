...
ggsave(
  filename = "Output/Descriptives/Dist_exp_pm25.png",
  plot     = p1,
  res      = 300,
  width    = 25,
  height   = 20,
...
ggsave(
  filename = "Output/Descriptives/Dist_exp_o3.png",
  plot     = p2,
  res      = 300,
  width    = 25,
  height   = 20,
...
ggsave(
  filename = "Output/Descriptives/Dist_exp_pm25_iqr.png",
  plot     = p3,
  res      = 300,
  width    = 25,
  height   = 20,
...
ggsave(
  filename = "Output/Descriptives/Dist_exp_o3_iqr.png",
  plot     = p4,
  res      = 300,
  width    = 25,
  height   = 20,
